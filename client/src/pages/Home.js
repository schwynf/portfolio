                ...
                <div className="row">
                    ...
                    <div className="col-sm-4">
                        ...
                        Node.js | Express.js | React.js | MongoDB | MySQL {''}
                            ...
                            <a data-toggle="modal" data-target="#exampleModal2" data-whatever="@mdo"><SocialIcon bgColor="black" fgColor="white" network="email" /></a>
                            <a data-toggle="modal" data-target="#exampleModal" ><SocialIcon bgColor="black" fgColor="white" network="" /></a>
