    ...
    return (
        <>
            <div className="container intro">
                ...
                <div className="row" id="intro-content">
                    ...
                    <div className="col-sm-6 intro-text pb-2">
                        ...
                        <div className="icons">
                            ...
                            <div href="" style={{display: "inline-block"}} data-toggle="modal" data-target="#exampleModal2" data-whatever="@mdo"><SocialIcon bgColor="black" fgColor="white" network="email"/></div>
                            <div href="/pdf" style={{display: "inline-block"}}  target="_blank"><SocialIcon bgColor="black" fgColor="white" network=""/></div>
                ...
                {/* <div className="row">
                    <div className="col-sm-12 interest pl-4"><h3>What I Do</h3></div>
                </div> */}
