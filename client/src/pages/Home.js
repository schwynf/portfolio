            ...
            <div className="container intro">
                ...
                <div className="row" id="intro-content">
                    <div className="col-sm-6 intro-img text-center">
                        <img src={profilePic} style={{ width: "21rem", height: "21rem" }} className="img-thumbnail img-fluid shadow-lg rounded-circle intro-picture" alt="Profile Img"></img>
                    </div>
                    <div className="col-sm-6 text-left intro-text pb-2">
